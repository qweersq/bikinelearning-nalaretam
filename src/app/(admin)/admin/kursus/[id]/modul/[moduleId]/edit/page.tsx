          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                min={1}
                step={1}
                className="w-full border border-stone-200 rounded-[14px] px-4 py-3 text-[15px] focus:outline-none focus:border-indigo-600 focus:ring-4 focus:ring-indigo-100 transition-all"
                value={form.order}
          ...
          <div className="mt-4">
            ...
            <div className="flex bg-[#f1f5f9] p-1 rounded-[12px] gap-1.5 max-w-[280px]">
              <button
                ...
                className={`flex-1 border-0 py-2 rounded-[8px] text-xs font-semibold transition-all cursor-pointer ${
                  form.isPublished 
