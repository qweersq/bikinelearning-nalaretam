  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          <h1 className="font-[family-name:var(--font-sora)] text-2xl font-bold text-stone-900">Tambah Modul</h1>
          <p className="mt-0.5 text-stone-500">Buat modul baru untuk kursus.</p>
        </div>
      </div>
      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <Input
            ...
            placeholder="dQw4w9WgXcQ (bagian setelah v= pada URL YouTube)"
            required
          />
          ...
          <div className="flex gap-3 pt-2">
            <Button type="submit" loading={loading}>Simpan Modul</Button>
